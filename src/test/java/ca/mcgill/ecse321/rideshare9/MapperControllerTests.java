...
public class MapperControllerTests {
	...
	@Mock private AdvertisementRepository advRepo;
	@Mock private UserService userService;
	@Mock private MapperUserAdvRepository mapRepo;
	@InjectMocks private MapperController mapperController;
	...
	public void canAddMap() throws Exception {
		UsernamePasswordAuthenticationToken principal = new UsernamePasswordAuthenticationToken("testPassenger", "testPassword", testPassenger.getAuthorities());
